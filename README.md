...
🛠️ Stack Tecnológico Framework: Flutter (Channel Stable).
...
🚦 Flujo de Git & Entornos Para garantizar la estabilidad del producto, el equipo trabajará bajo un esquema de tres ramas principales que segmentan el ciclo de vida del desarrollo:
...
Reglas del Encargado: Prohibido: Hacer push directo a main o qa.
